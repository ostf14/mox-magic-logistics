const RULES = [
  'Заклинание применяется получателем лично. Передача третьим лицам аннулирует страховку.',
  'Отправление вскрывается в момент применения. Вскрытое заранее заклинание службой не возмещается.',
  'Отправления класса II и выше не принимаются в отделениях, расположенных в жилых домах.',
  'Отправления класса III и выше не перевозятся в одной сумке с другими отправлениями.',
  ...
  'Одновременное применение двух и более заклинаний не рекомендуется. Последствия под страховку не подпадают.',
  ...
  'Курьер не консультирует по применению. Вопросы по эффекту адресуются мастерской-изготовителю.',
  'Служба не несёт ответственности за последствия применения заклинания не по указанной в карточке ситуации.',
